...
public class Venda {
    ...
    public Venda(Cliente cliente, Produto produto,
                 FuncionarioAdministrativo vendedor, int quantidade, LocalDate data) {
    ...
    public double getValorTotal() {
        ...
        double desconto = PlanoConfig.getDescontoProdutos(cliente.getPlano());
        return total * (1 - desconto);
    }

    public FuncionarioAdministrativo getVendedor() { return vendedor; }
}